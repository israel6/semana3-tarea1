...
--
ALTER TABLE `alumno1` ADD PRIMARY KEY (`codigo`),
...
--
ALTER TABLE `alumno1` MODIFY `codigo` int (5) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `alumno2` ADD PRIMARY KEY (`codigo`),
ADD KEY `index_cedula` (`cedula`);
...
--
ALTER TABLE `alumno2` MODIFY `codigo` int (5) NOT NULL AUTO_INCREMENT;

-- Consultas

--Buscar informacion del codigo 1 al 250000 de la tabla "alumno" a la tabla "alumno1"
INSERT INTO alumno1 SELECT * FROM alumno WHERE codigo BETWEEN 1 AND 250000; 

--Buscar informacion del codigo 250000 al 50000 de la tabla "alumno" a la tabla "alumno2"
INSERT INTO alumno2 SELECT * FROM alumno WHERE codigo BETWEEN 250000 AND 500000;